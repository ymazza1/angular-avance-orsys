...
const LIBS_ATTENDUES = [
  ...
  { chemin: 'libs/panier/domaine', nom: 'panier-domaine', type: 'domaine', domaine: 'panier' },
  { chemin: 'libs/panier/data-access', nom: 'panier-data-access', type: 'data-access', domaine: 'panier' },
  { chemin: 'libs/panier/ui', nom: 'panier-ui', type: 'ui', domaine: 'panier' },
] as const;
