 ...
 *   TAUX_ERREUR=0        probabilité d'une 503 sur /api/produits (0 à 1)
 *   DUREE_JETON=30       durée de vie du jeton d'accès en secondes
 */
...
const TAUX_ERREUR = Number(process.env.TAUX_ERREUR ?? 0);
const DUREE_JETON = Number(process.env.DUREE_JETON ?? 30);
