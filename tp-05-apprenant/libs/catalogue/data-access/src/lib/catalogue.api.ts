 ...
 * Adaptateur HTTP.
 *
 * Passé en Observable au TP 3 : une promesse ne sait ni s'annuler, ni se
 * composer avec un opérateur de temporisation. Le `firstValueFrom` du TP 2
 * jetait justement la seule chose qui nous intéresse maintenant.
 */
